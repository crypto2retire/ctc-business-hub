...
import { BarChart3, Globe, MousePointerClick, Clock, TrendingUp, Search, Facebook, Activity, ExternalLink, AlertCircle } from "lucide-react";
    ...
    <div className="p-8 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm">Website & marketing performance</p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-5">
            <TabsList className="bg-[#1d2332] border border-[#2d3344]">
